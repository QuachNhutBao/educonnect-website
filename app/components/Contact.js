      ...
      <div className="grid md:grid-cols-2 gap-8 max-w-4xl mx-auto">
        <div className="p-8 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
          ...
          <div className="space-y-4">
            <p className="flex items-center"><Phone className="h-5 w-5 mr-3 text-brand-blue" /><span>+84 934 045 240</span></p>
            <p className="flex items-center"><Mail className="h-5 w-5 mr-3 text-brand-blue" /><span>techenglish101@gmail.com</span></p>
          </div>
        </div>
        <div className="p-8 bg-white dark:bg-gray-900 rounded-lg shadow-lg">
          <h3 className="text-2xl font-bold mb-4">{content.malaysia_office}</h3>
          <div className="space-y-4">
            <p className="flex items-center"><Phone className="h-5 w-5 mr-3 text-brand-blue" /><span>+60 16 666 2785</span></p>
            <p className="flex items-center"><Mail className="h-5 w-5 mr-3 text-brand-blue" /><span>yeohsc@hotmail.com</span></p>
          </div>
        </div>
      </div>
    </section>
